...
ActiveRecord::Schema.define(version: 20140905174735) do
  ...
  add_index "articles", ["organisation_id"], name: "index_articles_on_organisation_id", using: :btree
  add_index "articles", ["user_id"], name: "index_articles_on_user_id", using: :btree

  create_table "attachment_trackers", force: true do |t|
  ...
  add_index "attachment_trackers", ["article_id"], name: "index_attachment_trackers_on_article_id", using: :btree
